...
let datePattern: String = "yyyy-MM-dd"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func setupImageChache() {
    ...
    fileprivate func setupNavigationBarAppearance() {
        ...
        UINavigationBar.appearance().barTintColor = ColorName.primaryColor.color
